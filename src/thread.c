...
// Data una lista di thread ritorna true se il thread a ha una priorità più alta del thread b
...
// Data una lista di thread ritorna true se il thread a ha una priorità più bassa del thread b
bool
thread_lower_priority (const struct list_elem *a_,
                        const struct list_elem *b_,
                         void *aux UNUSED)
...
// Se la ready list ha un thread con una priorità più alta lo cede
void thread_yield_to_higher_priority (void)
{
               ...
               thread_func *function, void *aux) 
{
  ...
  // Prepara il thread per la prima run inizializzando il suo stack.
...
/* Sets the current thread's priority to NEW_PRIORITY.
 + Se il thread corrente perde l' high priority allora la cede
*/
void
